...
import java.util.Random;
    ...
    public class World
    {
        ...
        public ArrayList<Robot> getRobotList ()
            ...
            /**
             * Méthdoe qui ajoute le robot KingRobot 
             */
          public void addKingRobot(String name, int X, int Y,Colour colour) {
            KingRobot kingRobot = new KingRobot(name, X, Y,colour, this);
            if (canMove(kingRobot, X, Y)) {
                live.add(kingRobot);
                kingRobot.draw();
            }
        }
